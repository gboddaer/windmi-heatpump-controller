...
bool JsonHelpers::parseTemperature(const std::string& json, const std::string& key,
                                   double& temperature)
{
  double temp;
...
std::string JsonHelpers::generateStatusJson(
    ...
    double heating_target, double outdoor_temp, double leaving_water_temp, const std::string& mode,
    const std::string& running_status, const std::string& priority, const std::string& status,
    bool device_online, double ac_current, double dc_current, double ac_voltage, double dc_voltage,
    double ac_power_va, double ac_power_w, bool power_valid, double compressor_freq,
    double water_flow, int unit_capacity_kw, int actual_capacity_output, int odu_input_status,
    int compressor_runtime_h, int pump_runtime_h, double heat_output_w, double cop, bool cop_valid,
    int working_mode)
{
...
std::string JsonHelpers::generateSuccessResponse(bool success, bool verified,
