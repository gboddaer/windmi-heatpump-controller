/**
 * @file header_example.hpp
 * @brief Example header demonstrating the WINDMI include guard style
 *
 * This file demonstrates the project's include guard convention:
 *   WINDMI_<PATH>_<FILE>_HPP_
 *
 * Include guard: WINDMI_EXAMPLE_HPP_
 */

#ifndef WINDMI_EXAMPLE_HPP_
#define WINDMI_EXAMPLE_HPP_
/*
...
constexpr std::array<RegisterInfo, 99> kRegisterMap{{
    ...
    {0x0001, "Outdoor air temperature", Access::ReadOnly, Scale::TemperatureTimes10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x0002, "Indoor air temperature", Access::ReadOnly, Scale::TemperatureTimes10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x0003, "Entering water temperature Tw-in", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    {0x0004, "Leaving water temperature T1", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    {0x0005, "Refrigerant temperature T2B", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    {0x000A, "Discharge temperature", Access::ReadOnly, Scale::TemperatureTimes10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x000B, "Air exchanger temperature T3", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},

    {0x0017, "Actual compressor frequency", Access::ReadOnly, Scale::FrequencyTimes10, std::nullopt,
     std::nullopt, std::nullopt},
    ...
    {0x01A5, "Occupied heating air setpoint", Access::ReadWrite, Scale::TemperatureTimes10, 160,
     320, 250},
    {0x01A6, "Unoccupied heating air setpoint offset", Access::ReadWrite, Scale::TemperatureTimes10,
     -200, 0, -40},
    {0x01A7, "Economic heating air setpoint offset", Access::ReadWrite, Scale::TemperatureTimes10,
     -200, 0, -20},
    {0x01A8, "Occupied cooling air setpoint", Access::ReadWrite, Scale::TemperatureTimes10, 160,
     320, 250},
    {0x01A9, "Unoccupied cooling air setpoint offset", Access::ReadWrite, Scale::TemperatureTimes10,
     0, 100, 40},
    {0x01AA, "Economic cooling air setpoint offset", Access::ReadWrite, Scale::TemperatureTimes10,
     0, 100, 20},

    {0x0245, "Heating climatic curve selection", Access::ReadWrite, Scale::Raw, -1, 12, -1},
    {0x0246, "Customized heating curve min OAT", Access::ReadWrite, Scale::TemperatureTimes10, -300,
     100, std::nullopt},
    {0x0247, "Customized heating curve max OAT", Access::ReadWrite, Scale::TemperatureTimes10, 100,
     300, std::nullopt},
    {0x0248, "Customized heating curve min LWT", Access::ReadWrite, Scale::TemperatureTimes10, 250,
     400, std::nullopt},
    {0x0249, "Customized heating curve max LWT", Access::ReadWrite, Scale::TemperatureTimes10, 300,
     600, std::nullopt},

    {0x024A, "Cooling climatic curve selection", Access::ReadWrite, Scale::Raw, -1, 2, -1},
    {0x024B, "Customized cooling curve min OAT", Access::ReadWrite, Scale::TemperatureTimes10, 0,
     300, std::nullopt},
    {0x024C, "Customized cooling curve max OAT", Access::ReadWrite, Scale::TemperatureTimes10, 240,
     500, std::nullopt},
    {0x024D, "Customized cooling curve min LWT", Access::ReadWrite, Scale::TemperatureTimes10, 50,
     200, std::nullopt},
    {0x024E, "Customized cooling curve max LWT", Access::ReadWrite, Scale::TemperatureTimes10, 50,
     200, std::nullopt},

    {0x019C, "Heating climatic curve max setpoint offset", Access::ReadWrite,
     Scale::TemperatureTimes10, -50, 50, 0},
    {0x019D, "Cooling climatic curve min setpoint offset", Access::ReadWrite,
     Scale::TemperatureTimes10, -50, 50, 0},

    {0x0191, "Occupied heating water setpoint", Access::ReadWrite, Scale::TemperatureTimes10, 250,
     630, std::nullopt},
    {0x0192, "Unoccupied heating water setpoint offset", Access::ReadWrite,
     Scale::TemperatureTimes10, -200, 0, -40},
    {0x0193, "Economic heating water setpoint offset", Access::ReadWrite, Scale::TemperatureTimes10,
     -200, 0, -20},
    {0x0197, "Occupied cooling water setpoint", Access::ReadWrite, Scale::TemperatureTimes10, 50,
     250, std::nullopt},
    {0x0198, "Unoccupied cooling water setpoint offset", Access::ReadWrite,
     Scale::TemperatureTimes10, 0, 100, 40},
    {0x0199, "Economic cooling water setpoint offset", Access::ReadWrite, Scale::TemperatureTimes10,
     0, 100, 20},

    {0x0055, "Pump speed", Access::ReadOnly, Scale::Raw, 0, 100, std::nullopt},
    {0x0033, "Water control point", Access::ReadWrite, Scale::TemperatureTimes10, 50, 630,
     std::nullopt},
    ...
    {0x025B, "Booster delta temperature", Access::ReadWrite, Scale::TemperatureTimes10, 10, 200,
     std::nullopt},
    {0x025C, "Booster OAT threshold", Access::ReadWrite, Scale::TemperatureTimes10, -200, 150,
     std::nullopt},
    {0x0202, "Minimum OAT for heating with compressor", Access::ReadWrite,
     Scale::TemperatureTimes10, -250, 100, std::nullopt},
    {0x0194, "DHW temp normal setpoint", Access::ReadWrite, Scale::TemperatureTimes10, 400, 630,
     std::nullopt},
    {0x0196, "DHW temp econ setpoint", Access::ReadWrite, Scale::TemperatureTimes10, 400, 630,
     std::nullopt},
    ...
    {0x02C9, "DHW mode - verify address", Access::ReadOnly, Scale::Raw, std::nullopt, std::nullopt,
     std::nullopt},
    {0x1C5B, "DHW tank temperature", Access::ReadOnly, Scale::TemperatureTimes10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x0195, "DHW anti-legionella setpoint", Access::ReadWrite, Scale::TemperatureTimes10, 600, 700,
     600},
    {0x02CA, "Anti-legionella scheduled days", Access::ReadWrite, Scale::Bitfield, 0, 0b11111110,
     std::nullopt},
    {0x02CB, "Anti-legionella scheduled starting time", Access::ReadWrite, Scale::TimeHHMM, 0, 2359,
     0},
    ...
    {0x1001, "IDU side capacity demand", Access::ReadOnly, Scale::Raw, std::nullopt, std::nullopt,
     std::nullopt},
    {0x1002, "Capacity demand after ODU receive", Access::ReadOnly, Scale::Raw, std::nullopt,
     std::nullopt, std::nullopt},
    {0x1004, "Actual capacity output", Access::ReadOnly, Scale::Raw, std::nullopt, std::nullopt,
     std::nullopt},
    {0x1005, "Fan speed", Access::ReadOnly, Scale::Raw, 0, 8, std::nullopt},
    {0x1008, "LWT after BPHE inside unit Tw-out", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    {0x1012, "EXV opening degree", Access::ReadOnly, Scale::OpeningDegreeDiv4, std::nullopt,
     std::nullopt, std::nullopt},
    {0x1013, "IPM refrigerant cool pipe temperature", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    ...
    {0x1019, "Compressor frequency limitation reason 1", Access::ReadOnly, Scale::Raw, std::nullopt,
     std::nullopt, std::nullopt},
    {0x1025, "Compressor frequency limitation reason 2", Access::ReadOnly, Scale::Raw, 0, 1,
     std::nullopt},
    {0x1020, "Program version", Access::ReadOnly, Scale::Raw, std::nullopt, std::nullopt,
     std::nullopt},
    {0x1021, "EEPROM version", Access::ReadOnly, Scale::Raw, std::nullopt, std::nullopt,
     std::nullopt},
    {0x1022, "P6 error reason / IPM protection reason", Access::ReadOnly, Scale::Raw, std::nullopt,
     std::nullopt, std::nullopt},
    {0x1023, "T9 IPM temperature", Access::ReadOnly, Scale::TemperatureTimes10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x1024, "T30 defrost logic temperature", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    {0x1026, "Target discharge temperature", Access::ReadOnly, Scale::TemperatureTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    ...
    {0x1009, "Alarm bitmap #1", Access::ReadOnly, Scale::Bitfield, std::nullopt, std::nullopt,
     std::nullopt},
    {0x100A, "Alarm bitmap #2", Access::ReadOnly, Scale::Bitfield, std::nullopt, std::nullopt,
     std::nullopt},
    {0x100B, "Alarm bitmap #3", Access::ReadOnly, Scale::Bitfield, std::nullopt, std::nullopt,
     std::nullopt},
    {0x100C, "Alarm bitmap #4", Access::ReadOnly, Scale::Bitfield, std::nullopt, std::nullopt,
     std::nullopt},

    {0x1006, "Capacity of unit", Access::ReadOnly, Scale::Raw, std::nullopt, std::nullopt,
     std::nullopt},
    {0x100D, "Ambient/water temperature control", Access::ReadWrite, Scale::Raw, std::nullopt,
     std::nullopt, std::nullopt},
    {0x100E, "ODU output status", Access::ReadOnly, Scale::Bitfield, std::nullopt, std::nullopt,
     std::nullopt},
    {0x100F, "Required compressor frequency", Access::ReadOnly, Scale::FrequencyTimes10,
     std::nullopt, std::nullopt, std::nullopt},
    {0x101A, "Required fan speed upper motor", Access::ReadOnly, Scale::RpmDiv10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x101B, "Required fan speed down motor", Access::ReadOnly, Scale::RpmDiv10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x101C, "Required opening degree of EXV", Access::ReadOnly, Scale::OpeningDegreeDiv4,
     std::nullopt, std::nullopt, std::nullopt},
    {0x101D, "Actual fan speed upper motor", Access::ReadOnly, Scale::RpmDiv10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x101E, "Actual fan speed down motor", Access::ReadOnly, Scale::RpmDiv10, std::nullopt,
     std::nullopt, std::nullopt},
    {0x101F, "Outdoor unit input status", Access::ReadOnly, Scale::Bitfield, std::nullopt,
     std::nullopt, std::nullopt},
    {0x102A, "Water flow feedback from water pump", Access::ReadOnly, Scale::FlowTimes100,
     std::nullopt, std::nullopt, std::nullopt},
