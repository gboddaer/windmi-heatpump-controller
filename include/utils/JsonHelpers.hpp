...
#ifndef WINDMI_UTILS_JSON_HELPERS_HPP_
#define WINDMI_UTILS_JSON_HELPERS_HPP_
...
public:
   ...
   */
  static bool parseTemperature(const std::string& json, const std::string& key,
                               double& temperature);
   ...
   * @return true if successful, false otherwise
   */
  static bool parseInt(const std::string& json, const std::string& key, long& value);
  ...
  static std::string generateStatusJson(
      double dhw_temp, double dhw_target, double heating_temp, double entering_water_temp,
      double heating_target, double outdoor_temp, double leaving_water_temp,
      const std::string& mode, const std::string& running_status, const std::string& priority,
      const std::string& status, bool device_online, double ac_current, double dc_current,
      double ac_voltage, double dc_voltage, double ac_power_va, double ac_power_w, bool power_valid,
      double compressor_freq, double water_flow, int unit_capacity_kw, int actual_capacity_output,
      int odu_input_status, int compressor_runtime_h, int pump_runtime_h, double heat_output_w,
      double cop, bool cop_valid, int working_mode);
   ...
   * @return JSON string
   */
  static std::string generateSuccessResponse(bool success, bool verified = false,
   ...
   * @return JSON string
   */
  static std::string generateErrorResponse(const std::string& error, int code = 400);
