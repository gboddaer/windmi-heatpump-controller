...
#ifndef WINDMI_CONFIG_H_
#define WINDMI_CONFIG_H_
...
#define REG_RUNNING_STATUS                                                                         \
  0x002D // R  - Current running status (0-5 normal, 7=defrost, 20=antifreeze)
...
#define REG_RUNNING_MODE                                                                           \
  0x002C // RW - Set mode: 0=Off, 1=Cool+DHW, 2=Heat+DHW (ONLY 0,1,2 allowed!)
